...
use ray_tracer_challenge::light::lighting;
use ray_tracer_challenge::light::point_light;
...
fn main() {
    ...
    let light = point_light(point!(-10, 10, -10), build_color(1.0, 1.0, 1.0));
        ...
        for x in 0..canvas_pixels - 1 {
            ...
            match Intersection::hit(&xs) {
                Some(hit) => {
                    ...
                    let color = lighting(hit.object.material, light, hit_point, eye, normal);
